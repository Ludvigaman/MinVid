**MinVid** - (Swedish "MyVid", or Minimalistic Video host), is a simple self hosted video website for those that want to keep your of videos and images on a self-hosted solution.
